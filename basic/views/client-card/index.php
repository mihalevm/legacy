...
<div>
    ...
    <div class="lgc_mainform">
        ...
        <label>Номер телефона: </label> <?=MaskedInput::widget(['name' => 'phone','mask' => '9-999-999-99-99', 'value'=>$client_params['phone'], 'options'=>['placeholder'=>'7-9XX-XXX-XX-XX', 'type'=>$field_type]]); ?><br/>
        <label>Дата рождения: </label><?= MaskedInput::widget(['name' => 'birth','mask' => '99.99.9999','value'=>$client_params['birthday'], 'options'=>['placeholder'=>'XX.XX.XXXX', 'type'=>$field_type]]);?><br/>
